...
object Prompt {
    ...
    fun generateQuestionPrompt(job: String, resumeType: String, career: String): String {
        val prompt = """
    ...
    fun generateAdvicePrompt(job: String, resumeType: String, career: String): String {
        val prompt = """
